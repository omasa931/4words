...
export class PlayGame2Page {
  ...
  constructor(
    ...
    console.log("PlayGame2Page.constructor")
    //現在のステージ
  ...
  ionViewDidLoad() {
    console.log("PlayGame2Page.ionViewDidLoad");
    this.commonlogic.showAddmobBanner(constant.ADMOB_BANNER_PLAY2);
  }

  ionViewWillEnter() {
    console.log("PlayGame2Page.ionViewWillEnter");
  }

  ionViewDidEnter() {
    console.log("PlayGame2Page.ionViewDidEnter");
  ...
  answerQuestion() {
    console.log("PlayGame2Page.answerQuestion");
    console.log();
    console.log(this.answer);
    let okng = "OK"
    if (this.qa1Data.reading == this.answer) {
      //console.log("正解");
      this.correct++;
    } else {
      //console.log("はずれ");
  ...
  setViewData(prm_qano: number) {
    console.log("PlayGame2Page.setViewData");
  ...
  seletAnswer(selectno: string){
    console.log("PlayGame2Page.seletAnswer")
    let okng = "OK"
  ...
  getJsonData() {
    console.log("PlayGame2Page.getJsonData");
  ...
  showAnswerModal(okng :string) {
    console.log("PlayGame2Page.showAnswerModal");
